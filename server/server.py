...
def process_folder():
    ...
    for audio_file in uploaded_files:
        ...
        response_for_qualify = is_qualified_gemini(filtered_answers) 
        print(response_for_qualify)
        # qualified = "Qualified" if is_qualified(filtered_answers) else "Not Qualified"
        row = [filename] + answers + [response_for_qualify]
        results.append(row)

    csv_text = StringIO()
    writer = csv.writer(csv_text)
    writer.writerow(["File Name"] + questions + ["Qualification Status"])
